...
class Node
{
    int dest; // integer representing the destination vertex
    Node *next;
...
class Graph
{
    string *places; // string pointer to store the names of the places (vertices)
    Node **adjList; // pointer to an array of Node pointers, representing the adjacency lists for each vertex
...
public:
    ...
    Graph(int n)
    {
        ...
        places = new string[nv]; //an array of strings of size nv
    }
